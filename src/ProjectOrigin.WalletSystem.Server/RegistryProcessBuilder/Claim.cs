...
{
    public async Task Claim(ReceivedSlice productionSlice, ReceivedSlice consumptionSlice)
    {
        ...
        {
            SliceStates = new(){
                {productionSlice.Id, ReceivedSliceState.Claimed},
                {consumptionSlice.Id, ReceivedSliceState.Claimed},
            }
        });
    ...
    private static AllocatedEvent CreateAllocatedEvent(Guid allocationId, ReceivedSlice consumption, ReceivedSlice production)
    {
